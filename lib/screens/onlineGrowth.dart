...
class OnlineGrowthScreen extends StatefulWidget {
  const OnlineGrowthScreen({Key? key}) : super(key: key);

  @override
  State<OnlineGrowthScreen> createState() => _OnlineGrowthScreen();
}

class _OnlineGrowthScreen extends State<OnlineGrowthScreen> {
  @override
